 ...
 */ (function (b) {
	...
	function g() {
		...
		function t(c, r, s) {
			var a,
				u = !0;
			return typeof CustomEvent == "function" ? (a = new CustomEvent(r, { bubbles: u, detail: s })) : ((a = document.createEvent("CustomEvent")), a.initCustomEvent(r, u, !1, s)), c.dispatchEvent(a), a;
		}
		function f(c, r, s) {
			T(c, function (a) {
				a &&
	...
	function F(n, e, i) {
		var t = $(n),
			...
			r;
		function s() {
			window.IntersectionObserver && ((r = new IntersectionObserver(u, { root: o.root, rootMargin: o.rootMargin, threshold: o.threshold })), r.observe(n.root));
		}
		function a() {
	...
	typeof window < "u" && ((window.splide = window.splide || {}), (window.splide.Extensions = window.splide.Extensions || {}), (window.splide.Extensions.Intersection = F));
});
